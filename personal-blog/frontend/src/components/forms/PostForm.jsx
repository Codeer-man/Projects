...
//     console.log("Saved Data:", savedData); // Log to inspect the content structure
//     return savedData;
//   };

//   const handleEditorChange = (newContent) => {
//     // Update the state with the editor content (if necessary)
...
//   const newBlog = async (editorData, title) => {
//     setLoading(true);
//     setError(null);
...
//             author: user._id,
//             authorUsername: user.autherusername,
//             image,
//           }),
//         }
//       );
...
//     const editorData = await handleSave();
//     if (!editorData.blocks || editorData.blocks.length === 0) {
//       toast.error("Please add some content!");
//       return;
//     }

//     // Extract title from the first block (assuming it's a header)
//     const title = editorData.blocks[0]?.data?.text || "Untitled Post";

//     // Send the title and content
//     await newBlog(editorData, title);
//   };
...
//                   placeholder="Write your post here... You can add headings, images, lists, and more!"
//                   defaultValue={{
//                     blocks: [
//                       {
//                         type: "header",
...
//                     ],
//                   }}
//                   onChange={handleEditorChange} // Attach handleEditorChange here
//                 />
//               </div>
